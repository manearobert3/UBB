			...
			while (exitVariable == 0)
			{
				...
				while (verifyExistenceGenre == 0 and genreInputted != "null") {
					...
					while (indexVerifying < this->service.getSize())
					{
						...
						{
								verifyExistenceGenre = 1;
						}
						indexVerifying++;
					}
					if (verifyExistenceGenre == 0) {
