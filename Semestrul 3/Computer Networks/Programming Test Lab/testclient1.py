...
def udp_client_creation(ip_addr,port):
...
def udp_recv_string(sock):
    string, address = sock.recvfrom(1024).decode('ascii')
...
def client_program():
    ...
    try:
        ...
        udp_socket = udp_client_creation(host,portUdp)

    except socket.error as msg:
        print("Error1: ", msg.strerror)
        exit(-1)
